package.path = package.path .. ";/home/GLIB/?.lua;/home/GLIB/lib/glib/?.lua;;/home/GLIB/lib/nidas/?.lua"

local gui = require("lib.nidas.graphics.gui")
...
local function save()
    ...
    local file = io.open("/home/settings/enabledModules", "w")
...
local function load()
    local file = io.open("/home/settings/enabledModules", "r")
